...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    let stuONe=Student(firstName: "宇童", lastName: "蒋", age: 20, gender: .female, stuNo: "0001")
    let stuTwo=Student(firstName: "童宇", lastName: "蒋", age: 20, gender: .female, stuNo: "0002")
    let stuThree=Student(firstName: "蒋宇", lastName: "童", age: 20, gender: .female, stuNo: "0003")
    let stuFour=Student(firstName: "蒋童", lastName: "宇", age: 20, gender: .female, stuNo: "0004")
    let teacOne=Teacher(firstName: "贵洋", lastName: "李", age: 40, gender: .male, title: "教授")
    let teacTwo=Teacher(firstName: "路", lastName: "张", age: 41, gender: .female, title: "副教授")
    let teacThree=Teacher(firstName: "颜值  ", lastName: "高", age: 42, gender: .male, title: "副教授")
    let teacFour=Teacher(firstName: "良", lastName: "谭", age: 43, gender: .female, title: "教授")
